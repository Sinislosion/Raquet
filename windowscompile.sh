...
x86_64-w64-mingw32-clang -std=c99 src/main.c -Wall -O2 -o build/win/prog -Imingwlibgme/include/ -Lmingwlibgme/lib/ -lgme -ISDL2-2.30.0/x86_64-w64-mingw32/include/ -LSDL2-2.30.0/x86_64-w64-mingw32/lib/ -lSDL2 -lSDL2main -static-libgcc -static-libstdc++ -I ./
if [ -e "build/win/prog.exe" ]; then
	echo "Copying Assets"
	...
	cp -r SDL2-2.30.0/x86_64-w64-mingw32/bin/SDL2.dll build/win
